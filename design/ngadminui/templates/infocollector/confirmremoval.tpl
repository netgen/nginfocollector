...
<div class="panel">
    ...
    <div class="controlbar">
        ...
        <form action={concat( $module.functions.extracollectionlist.uri, '/', $object_id )|ezurl} method="post" name="CollectionRemove">
            <input class="btn btn-primary" type="submit" name="ConfirmRemoveButton" value="{'OK'|i18n( 'design/admin/infocollector/confirmremoval' )}" />
            <input class="btn btn-default" type="submit" name="CancelRemoveButton" value="{'Cancel'|i18n( 'design/admin/infocollector/confirmremoval' )}" />
        </form>
    </div>
