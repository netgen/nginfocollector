<form name="collections" method="post" action={concat( '/nginfocollector/extracollectionlist/', $object.id )|ezurl}>
...
{* DESIGN: Content START *}
    <div class="panel">
        ...
        <input class="button" type="submit" name="SearchCollectionsButton" value="{'Search collections'|i18n( 'design/admin/infocollector/collectionlist' )}" title="{'Search collection.'|i18n( 'design/admin/infocollector/collectionlist' )}" />
        ...
        <input class="button" type="submit" name="AnonymizeCollectionsButton" value="{'Anonymize selected'|i18n( 'design/admin/infocollector/collectionlist' )}" title="{'Remove selected collection.'|i18n( 'design/admin/infocollector/collectionlist' )}" />
        {else}
